#!/bin/bash
#SBATCH -J encoder_atp_ukb_dzne_bs8_ep1000_lr0.001
#SBATCH -N 1
...
srun python main.py \
        ...
        --proj_name=MAEwithAttentiveProbing \
        --dataset=dzne \
        --data_path=/dss/dsshome1/0C/ge79qex2/ModelsGenesis/dataset/DZNE/ \
        --batch_size=8 \
        --run_name=encoder_atp_ukb_dzne_bs8_ep1000_lr0.001 \
